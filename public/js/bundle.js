...
/***/ function(module, exports, __webpack_require__) {
	...
	var TweetsApp = __webpack_require__(158);
	...
	ReactDOM.render(React.createElement(TweetsApp, { tweets: initialState }), document.getElementById('react-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Tweets = __webpack_require__(159);
	var Loader = __webpack_require__(161);
	var NotificationBar = __webpack_require__(162);
	...
	var TweetsApp = function (_React$Component) {
	    ...
	    function TweetsApp(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TweetsApp).call(this, props));
	        ...
	        value: function loadPagedTweets(tweets) {
	            ...
	            if (tweets.length > 0) {
	                (function () {
	                    ...
	                    // Get current application state
	                    var updated = _this2.state.tweets;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Tweet = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tweet = function Tweet(props) {
	    ...
	    return React.createElement(
	        'li',
	        { className: "tweet" + (tweet.active ? ' active' : ''), key: tweet.twid_str },
	        ...
	        React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'a',
	                    { target: '_blank', href: "http://www.twitter.com/" + tweet.screenname + (tweet.twid_str ? '/status/' + tweet.twid_str : '') },
	                    tweet.author
	                ),
	                React.createElement(
	                    'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = function Loader(props) {
	    return React.createElement(
	        'div',
	        { className: "loader " + (props.paging ? 'active' : "") },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationBar = function NotificationBar(props) {
	    ...
	    return React.createElement(
	        'div',
	        { key: 'notification', className: "notification-bar" + (count > 0 ? ' active' : '') },
	        React.createElement(
	            'p',
	            null,
	            'There ',
	            ...
	            React.createElement(
	                'a',
	                { href: '#top', onClick: props.onShowNewTweets },
	                'Click here to see ',
	                count > 1 ? 'them' : 'it',
	                '.'
	            )
